...
from adb_mouse import AdbMouse
...
class PrepareMPT():
    ...
    def prepare_mpt(self):
        ...
        if self.adb_tools.devices:
            ...
            self.d.click(constants.FIRST_START_X, constants.FIRST_START_Y)
            time.sleep(1)
            self.d.click(constants.AUTH_CODE_EDITBOX_X, constants.AUTH_CODE_EDITBOX_Y)
            time.sleep(1)
            for code in constants.AUTH_CODE_16BIT:
                self.d.press(code)
                time.sleep(1)
            time.sleep(2)
            self.d.click(constants.AUTH_CODE_NEXTSTEP_X, constants.AUTH_CODE_NEXTSTEP_Y)
            time.sleep(2)
            self.d.click(constants.AUTH_CODE_NEXTSTEP_X, constants.AUTH_CODE_NEXTSTEP_Y)
